      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2 flex-wrap">
            ...
            className="font-semibold text-sm text-neutral-900 hover:text-primary-600 transition-colors line-clamp-2 block mb-2"
          >
            {citation.title}
          </a>
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="shrink-0 text-neutral-400 hover:text-primary-600 transition-colors mt-1"
